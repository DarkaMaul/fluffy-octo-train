...
<figure markdown>
  ![Iris et Alexis](img/alexisyiris.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![Our gear laying on the bed before departure](img/gear.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![Iris et Alexis](img/buscochrane.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![View from the back of a pickup](img/stop.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![Iris et Alexis](img/lider.png){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![Iris et Alexis](img/camp19.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![Iris in front of the Cariberineros Office in Puerto William](img/carabineros.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![A navigation device is useful because sometimes there is no path](img/navigation.jpg){ loading=lazy width=400px data-gallery="index"}
...
<figure markdown>
  ![Sopaipilla Workshop with Umberto](img/sopaipilla.jpg){ loading=lazy width=400px data-gallery="index"}
